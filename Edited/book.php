...
require_once "config.php";
 ...
 $query1= "SELECT * FROM vehicle_booking WHERE user = '".$_SESSION['username']."' ";
 $query2= "SELECT * FROM reservation WHERE user = '".$_SESSION['username']."' ";
...
<body class="main-layout">
    ...
    <h1 style="color:White; text-align: center;">Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Your Booking is Confirmed </h1>
    <h1 style="color:White; text-align: center;">Your Vehicle Licence Number is <b><?php echo htmlspecialchars($row1['vehicleLN']); ?></b></h1>
       ...
       <div class="full text_align_left">
		...
		<table style="margin-left: auto; margin-right: auto;">
				...
				<tr>
					...
					<td><?php echo $row1["vehicleLN"]; ?></td>
				</tr>				
				<tr>
					<td>Status of Repair or Service</td>
					<td><?php echo $row2["VehicleStatus"]; ?></td>
				</tr>
				<tr>
					<td>Total Cost for Parts</td>
					<td><?php echo $row2["partCost"]; ?></td>
				</tr>
				<tr>
					<td>Total Cost for Repair or Service</td>
					<td><?php echo $row2["repairCost"]; ?></td>
				</tr>
		</table>
			<p style="text-align: center;">
